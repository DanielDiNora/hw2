...
function ricerca2(event) {
    ...
    const url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/'+splitUrl[4]+'/api_nutritionix?query=';
...
const url=window.location.href;
var splitUrl = url.split('/');
url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/'+splitUrl[4]+'/fetch_service'; 
console.log(url2);
fetch(url2).then(onResponse).then(content);
var Servizi='';
const url3=window.location.href;
var splitUrl = url3.split('/');
url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/'+splitUrl[4]+'/fetch_doctor';
